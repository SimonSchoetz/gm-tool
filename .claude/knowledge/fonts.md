...
**Citation:** [architect_1: WebFetch https://raw.githubusercontent.com/IBM/plex/master/LICENSE.txt — SIL OFL 1.1, confirmed]
...
**Citation:** [architect_2: WebFetch https://fontsource.org/fonts/ibm-plex-sans — package existence and per-weight CSS entry points confirmed]
...
**Citation:** [spec-writer_5: WebFetch vite.dev/guide/features.html — page confirms postcss-import-based `@import` inlining but does not confirm bare npm specifier resolution from a `.css` file's `@import`]
