...
Read this plugin's `agents/spec-writer.md` and apply its process, output format, and behavior rules in full. You are operating in the main conversation thread as the write-specs skill rather than as a spawned agent — apply the same process, output format, and behavior rules.
