...
export const locationNotFoundError = (id: string): LocationNotFoundError => {
  const error = new Error(`Location with id ${id} not found`) as LocationNotFoundError;
...
export const locationUpdateError = (id: string, cause?: unknown): LocationUpdateError => {
  const error = new Error(
...
export const locationDeleteError = (id: string, cause?: unknown): LocationDeleteError => {
  const error = new Error(
