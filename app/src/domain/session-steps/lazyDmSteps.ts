...
export const LAZY_DM_STEPS: LazyDmStepDefinition[] = [
  {
    ...
    placeholder:
      'What do they want? What plays into their backgrounds? What do their players enjoy?',
  },
  {
    key: 'strong_start',
    name: 'Strong Start',
    ...
    placeholder:
      "Describe the opening scene — what's happening and what immediately demands attention?",
  },
  {
    ...
    placeholder:
      'A few words per scene, one or two scenes per expected hour of play',
  },
  {
    key: 'secrets_clues',
    name: 'Secrets & Clues',
    ...
    placeholder:
      'Short, context-free clues the characters might discover — one sentence each',
  },
  {
    ...
    placeholder: 'Name the location, then list three evocative details',
  },
  {
    key: 'important_npcs',
    name: 'Important NPCs',
    ...
    placeholder:
      'Name, connection to the adventure, and a fictional archetype they embody',
  },
  {
    ...
    placeholder:
      'Which monsters fit this location and situation? Consider their CR.',
  },
  {
    key: 'magic_items',
    name: 'Loot & Rewards',
    ...
    placeholder: 'Items that connect to a character, a theme, or the story',
  },
];
